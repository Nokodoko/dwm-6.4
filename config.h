...
static const char *fonts[] = {"VictorMono  :size=15"};
static const char dmenufont[] = "VictorMono:size=15";
...
/* tagging */
static const char *tags[] = { ">_", "(-.x)", "~>", "4", "5", "6", "7", "8", "9" };
...
static const Key keys[] = {
	...
	{ MODKEY|Mod4Mask|ShiftMask,    XK_i,      incrigaps,      {.i = -2 } },
