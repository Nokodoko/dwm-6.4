...
static const int sidepad            = 55;       /* horizontal padding of bar */
static const char *fonts[] = {"VictorMono Nerd Font Mono:style=Italic:size=20"};  
static const char dmenufont[] = "VictorMono Nerd Font Mono:style=Italic:size=20"; 
...
/* tagging */
static const char *tags[] = { ">_", "❝ ❞", "｛｝", "~>", "5", "6", "7", "8", "9" };
